            ...
            <div className="card text-center">
              ...
              <div className="card-body">
                ...
                <div className="d-flex justify-content-center gap-2 flex-wrap">
                  ...
                  <Link to="/leaderboard" className="btn btn-outline-success">Leaderboard</Link>
                  <Link to="/teams" className="btn btn-outline-info">Teams</Link>
                  <Link to="/users" className="btn btn-outline-secondary">Users</Link>
                  <Link to="/workouts" className="btn btn-outline-warning">Workouts</Link>
                </div>
              </div>
            </div>
          } />
